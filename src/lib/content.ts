...
export const nav = [
  ...
  { hash: "why", label: "Why Theosis" },
  { hash: "contact", label: "Contact" },
  { hash: "plans", label: "Future plans" },
] as const;
