import { u as getMinute, y as minutesIntro } from "./_ssr/minutes-CSOrjEqq.mjs";
import { _ as Link } from "./_libs/@tanstack/react-router+[...].mjs";
import { i as require_jsx_runtime } from "./_libs/@radix-ui/react-label+[...].mjs";
import { w as ArrowLeft } from "./_libs/lucide-react.mjs";
import { a as Route$7 } from "./_ssr/router-CkHkuqSF.mjs";
import { r as SiteShell, t as Button } from "./_ssr/site-shell-Bl8Cvnwr.mjs";
import { n as NerdStepper, r as VideoCard, t as EnlargeableImage } from "./_ssr/video-card-DgA1Pndj.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_slug-8S2oYOIC.js
...
function MinutePage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiteShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		className: `mx-auto px-5 py-16 sm:px-8 lg:py-24 ${minute.slug === "create-diabetic" ? "max-w-6xl" : "max-w-3xl"}`,
		children: [
			...
			minute.slug !== "create-diabetic" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-8 font-display text-3xl font-semibold text-accent",
					children: minute.group === "interactive" ? "Interactive physiology" : minute.n
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
			...
			minute.slug === "create-diabetic" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-8",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("iframe", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
						href: "/personal-fat-threshold-v12-2026-09-10.html",
						className: "text-accent hover:text-fg",
						children: "Open the model in its own tab"
					})
				})]
			}) : null,
			...
			minute.videoId ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-10",
