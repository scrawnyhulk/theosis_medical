...
import { o as Route$10 } from "./_ssr/router-CkHkuqSF.mjs";
import { i as cn, r as SiteShell, t as Button } from "./_ssr/site-shell-Bl8Cvnwr.mjs";
import { t as Input } from "./_ssr/input-3yV5yz54.mjs";
import { t as NerdParagraph } from "./_ssr/nerd-paragraph-CQuEwJxw.mjs";
import { n as NerdStepper, r as VideoCard, t as EnlargeableImage } from "./_ssr/video-card-DgA1Pndj.mjs";
import { t as Label } from "./_ssr/label-CkPBTni9.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_slug-BvxbISrC.js
...
function StartCalculator({ compact = false }) {
	const [pounds, setPounds] = (0, import_react.useState)("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			compact ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Calories = body weight × a goal number. Protein = 1 g per pound."
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 max-w-xl text-muted",
					children: "Calories = body weight × 7–21. Protein = 1 g per pound. Leftover calories are ordinary food."
				})
			] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: goals.map((g) => {
							...
							const also = "also" in g ? g.also : void 0;
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								type: "button",
								size: "sm",
								variant: selected ? "default" : "outline",
								className: also ? "h-auto min-h-11 flex-col items-start gap-0.5 whitespace-normal py-2 text-left" : void 0,
								onClick: () => setGoalId(g.id),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: g.label }), also ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: cn("text-[0.7rem] font-medium tracking-wider uppercase", selected ? "text-accent-fg/80" : "text-muted"),
									children: also
								}) : null]
							}, g.id);
						})
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-4 max-w-xl text-sm leading-relaxed text-warn",
						children: "On insulin or other glucose-lowering meds? Don’t start a drastic calorie cut without talking with your physician first."
					})
				]
			}),
	...
	if (slug === "helpful-videos") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: referenceVideos.map((video) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(VideoCard, {
			...
			children: [
				"Also on",
				" ",
				"section" in video.usedOn && video.usedOn.section === "minutes" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/minutes/$slug",
