...
import { C as nerdTopics, N as whyParagraphs, S as nerdGroups, b as nav, j as site, m as hacks, t as aboutParagraphs, v as minutes } from "./minutes-CSOrjEqq.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/site-shell-Bl8Cvnwr.js
...
var index = [
	...
	})),
	{
		...
		hrefKind: "minutes",
		haystack: pack("medical minutes", "ear fever cough back sprain ct pneumonia sepsis antibiotic resistance amoxicillin leftover", "interactive physiology create a diabetic personal fat threshold")
	},
	...minutes.map((m) => ({
		id: `minute-${m.slug}`,
		section: "Medical Minutes",
