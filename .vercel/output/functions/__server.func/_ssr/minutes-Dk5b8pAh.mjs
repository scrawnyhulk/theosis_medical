import { v as minutes, y as minutesIntro } from "./minutes-CSOrjEqq.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/minutes-Dk5b8pAh.js
var import_jsx_runtime = require_jsx_runtime();
function MinuteCard({ minute, featured }) {
	if (minute.cover) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			className: `relative block overflow-hidden rounded-xl ${featured ? "aspect-[16/10] sm:aspect-[21/9]" : "aspect-[3/2]"}`,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					src: minute.cover,
					alt: minute.coverAlt ?? minute.title,
					className: `absolute inset-0 size-full object-cover transition-transform duration-700 ease-out group-hover:scale-105 ${minute.coverObject ?? "object-center"} ${minute.coverObject === "object-top" ? "origin-top" : ""}`
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: `relative z-10 flex h-full min-h-11 flex-col justify-end ${featured ? "p-6 sm:p-10" : "p-6 sm:p-8"}`,
					children: [
						minute.group === "interactive" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs font-medium tracking-widest text-accent uppercase",
							children: "Interactive physiology"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: `mt-2 block leading-relaxed text-white/85 ${featured ? "max-w-2xl text-base sm:text-lg" : "text-sm sm:text-base"}`,
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-3 font-display text-4xl font-semibold tracking-wide sm:text-5xl",
						children: "Interactive physiology"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-4 max-w-2xl text-lg leading-relaxed text-muted",
						children: "Models you can move, not just read. Slide the fuel in and watch where it goes."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-8 space-y-4",
						children: interactive.map((minute) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MinuteCard, {
							minute,
							featured: true
						}, minute.slug))
					})
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-4 max-w-2xl text-lg leading-relaxed text-muted",
						children: "The explanations I give over and over in the emergency department."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-8 grid gap-4 md:grid-cols-2",
						children: [talks.map((minute) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MinuteCard, { minute }, minute.slug)), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
							href: "/#suggest",
							className: "group block overflow-hidden rounded-xl bg-ink shadow-border",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
